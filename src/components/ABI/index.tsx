...
export const governancePool = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_minYflForProposal', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_yflPurchaser', type: 'address' }],
