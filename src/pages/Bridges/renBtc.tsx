...
export default function RenBtc() {
  ...
  const balance = useTokenBalances(account ?? undefined, [renBTC])
  const userBalance = balance[renBTC.address]
            ...
            {action === 'mint' ? (
                ...
                {depositAddress ? (
                  <AutoColumn gap={'18px'}>
                    <RowBetween>
                      ...
                      <Text>{t('minimumAmount', { currency: Asset.BTC, minimumAmount: minimumAmount ?? 0 })}</Text>
                    </RowBetween>
                    <Text textAlign="center">{t('sendCurrencyTo', { currency: Asset.BTC })}:</Text>
                    <BlueCard>
                      <TYPE.link textAlign="center" fontWeight={400}>
              ...
              <AutoColumn gap={'12px'}>
                ...
                <Input
                  ...
                  autoCapitalize="off"
                  spellCheck="false"
                  placeholder={t('walletAddress', { currency: 'Bitcoin' })}
                  onChange={e => {
                    setErrorMessage(null)
