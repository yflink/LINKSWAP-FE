...
export default function RenZec() {
  ...
  const balance = useTokenBalances(account ?? undefined, [renZEC])
  const userBalance = balance[renZEC.address]
  ...
  const inputCurrency = 'ZEC'
  const outputCurrency = 'renZEC'
            ...
            {action === 'mint' ? (
                ...
                {depositAddress ? (
                  <AutoColumn gap={'18px'}>
                    <RowBetween>
                      ...
                      <Text>{t('minimumAmount', { currency: Asset.ZEC, minimumAmount: minimumAmount ?? 0 })}</Text>
                    </RowBetween>
                    <Text textAlign="center">{t('sendCurrencyTo', { currency: Asset.ZEC })}:</Text>
                    <BlueCard>
                      <TYPE.link textAlign="center" fontWeight={400}>
              ...
              <AutoColumn gap={'12px'}>
                ...
                <Input
                  ...
                  autoCapitalize="off"
                  spellCheck="false"
                  placeholder={t('walletAddress', { currency: 'Zcash' })}
                  onChange={e => {
                    setErrorMessage(null)
