...
export default function RenDoge() {
  ...
  const inputCurrency = 'DOGE'
  const outputCurrency = 'renDOGE'
                ...
                {depositAddress ? (
                  <AutoColumn gap={'18px'}>
                    <RowBetween>
                      ...
                      <Text>{t('minimumAmount', { currency: Asset.DOGE, minimumAmount: minimumAmount ?? 0 })}</Text>
                    </RowBetween>
                    <Text textAlign="center">{t('sendCurrencyTo', { currency: Asset.DOGE })}:</Text>
                    <BlueCard>
                      <TYPE.link textAlign="center" fontWeight={400}>
