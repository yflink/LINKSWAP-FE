...
export default function RenDoge() {
  ...
  const balance = useTokenBalances(account ?? undefined, [renFIL])
  const userBalance = balance[renFIL.address]
  ...
  const inputCurrency = 'FIL'
  const outputCurrency = 'renFIL'
            ...
            {action === 'mint' ? (
                ...
                {depositAddress ? (
                  <AutoColumn gap={'18px'}>
                    <RowBetween>
                      ...
                      <Text>{t('minimumAmount', { currency: Asset.FIL, minimumAmount: minimumAmount ?? 0 })}</Text>
                    </RowBetween>
                    <Text textAlign="center">{t('sendCurrencyTo', { currency: Asset.FIL })}:</Text>
                    <BlueCard>
                      <TYPE.link textAlign="center" fontWeight={400}>
              ...
              <AutoColumn gap={'12px'}>
                ...
                <Input
                  ...
                  autoCapitalize="off"
                  spellCheck="false"
                  placeholder={t('walletAddress', { currency: 'Filecoin' })}
                  onChange={e => {
                    setErrorMessage(null)
